...
Head.EffectiveDate.sec={Def.Effective_Date.sec}: {EffectiveDate.YMD}
...
Among.Def.sec/NotTarget=Each a "{_Party}" and collectively the "{_Parties}."
...
This.sec/2-NotTarget=This {_Agreement} is made as of {EffectiveDate.YMD} (the "{_Effective_Date}"), by and between the {_Parties}.

This.sec/3=This {Doc.Ti} (this "{Def.Agreement.sec}") is made as of {EffectiveDate.YMD} ("{Def.Effective_Date.sec}"), by and among the {_Parties}.

This.sec/3-NotTarget=This {_Agreement} is made as of {EffectiveDate.YMD} (the "{_Effective_Date}"), by and among the {_Parties}.
